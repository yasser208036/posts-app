...
- Folder: `.squad/stories/posts/enhance-posts-logic/intake.md`
...
```
make one api return all posts your posts and frineds posts
all poasts show in main page and remove Friends' Posts page (/feed)
use post card in feed page for all posts
```
